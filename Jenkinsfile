...
podTemplate(label: 'jenkins-pipeline', containers: [
    ...
    containerTemplate(name: 'docker', image: 'docker:1.12.6', command: 'cat', args: '', ttyEnabled: true),
    containerTemplate(name: 'maven', image: 'maven:3.5-jdk-8', command: 'cat', args: '', ttyEnabled: true),
    containerTemplate(name: 'helm', image: 'lachlanevenson/k8s-helm:v2.6.1', command: 'cat', args: '', ttyEnabled: true),
    containerTemplate(name: 'kubectl', image: 'lachlanevenson/k8s-kubectl:v1.8.3', command: 'cat', args: '', ttyEnabled: true)
],
volumes:[
